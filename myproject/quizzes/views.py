...
def _validate_questions_have_answers(post) -> list[int]:
    """
    Возвращает номера (1-based) вопросов, где текст вопроса заполнен,
    но нет ни одного непустого варианта ответа.
    """
    try:
